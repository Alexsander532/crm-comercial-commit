    ...
    <BrowserRouter>
      <AuthProvider>
        <Routes>
          ...
          <Route path="/leads/new" element={<ProtectedRoute><Layout><LeadFormPage /></Layout></ProtectedRoute>} />
          <Route path="/leads/:id" element={<ProtectedRoute><Layout><LeadDetailPage /></Layout></ProtectedRoute>} />
          <Route path="/leads/:id/edit" element={<ProtectedRoute><Layout><LeadFormPage /></Layout></ProtectedRoute>} />
